...
#
export TOOL=com.pdfunit.tools.ExtractXFAData
export OUT_DIR=$PWD/../tmp
echo ************************************************************** 
echo * define the path to your PDF inside this script
echo ************************************************************** 
export IN_FILE=$PWD/../example-files/xfa-enabled.pdf
export PASSWD=
#
java $TOOL  $IN_FILE  $OUT_DIR  $PASSWD

echo a file with the prefix '_xfadata_' was created in $OUT_DIR.
